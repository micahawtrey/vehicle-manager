        ...
        <div className="offset-3 col-6">
          <div className="shadow p-4 mt-4">
            ...
            <form onSubmit={handleSubmit} id="create-salesperson-form">
              ...
              <div className="form-floating mb-3">
                <input value={formData.employee_id} onChange={handleFormChange} placeholder="Employee id" maxLength="100" required type="number" name="employee_id" id="employee_id" className="form-control" />
